...
/**
 * Admin resource Controlling
 * Nee to have a special header before
 * @author Software
 *
 */
public class AdminResourceGuard extends HttpRequestGuard implements ResourceGuardInterface {
	...
	public void canActivate(HttpServletRequest request, HttpServletResponse response) 
			...
			InvalidContentTypeException, InvalidBodyFormatException, InvalidAdminPassphraseException {
	...
	public AdminResourceGuard(ServletContext context, HttpServletRequest request, HttpServletResponse response,
