...
/**
 * Servlet implementation class VerifyPhoneController
 */
@WebServlet("/api/v1/member/security/check/phone")
		...
		try {
			...
			if (request.getHeader("Content-Type").equals("application/json")) {
				try {
					...
					boolean selected = MysqlDaoFactory.getMemberDaoRepository().findByPhone(phone);
