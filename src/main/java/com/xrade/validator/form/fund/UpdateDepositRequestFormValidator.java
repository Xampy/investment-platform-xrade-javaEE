...
public class UpdateDepositRequestFormValidator extends AbstractFormValidator<MemberDepositRequestEntity>  {
	...
	@Override
	public MemberDepositRequestEntity validate(HttpServletRequest request) throws Exception {
	...
	private long validateMemberAccountId(String fieldname, HttpServletRequest request) throws Exception{
		try{
	...
	private String validatePayment(String fieldname, HttpServletRequest request) throws Exception{
		try{
	...
	private int validateAmount(String fieldname, HttpServletRequest request) throws Exception{
		try{
	...
	private int validateAmountBefore(String fieldname, HttpServletRequest request) throws Exception{
		try{
			return  Integer.parseInt(this.getFieldValue(fieldname, request));
		}catch (Exception e) {
			throw new Exception("The field " + fieldname + " is required");
	...
	private int validateAmountAfter(String fieldname, HttpServletRequest request) throws Exception{
		try{
			return  Integer.parseInt(this.getFieldValue(fieldname, request));
		}catch (Exception e) {
			throw new Exception("The field " + fieldname + " is required");
	...
	private String validateMetadata(String fieldname, HttpServletRequest request) throws Exception{
		try{
			return this.getFieldValue(fieldname, request);
		}catch (Exception e) {
			throw new Exception("The field " + fieldname + " is required");
	...
	private boolean validateFilled(String fieldname, HttpServletRequest request) throws Exception{
		try{
	...
	private String validateDate(String fieldname, HttpServletRequest request) throws Exception{
		try{
			return this.getFieldValue(fieldname, request);
		}catch (Exception e) {
			throw new Exception("The field " + fieldname + " is required");
