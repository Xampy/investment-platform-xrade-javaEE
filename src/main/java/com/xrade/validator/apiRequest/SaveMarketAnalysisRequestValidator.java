...
public class SaveMarketAnalysisRequestValidator extends AbstractRequestValidator<MarketAnalysisEntity> {
	...
	@Override
	public MarketAnalysisEntity validate(JSONObject request) throws Exception {
	...
	public String validateMarket(String fieldname, JSONObject request) throws Exception{
		try{
	...
	public int validateTotalLot(String fieldname, JSONObject request) throws Exception{
		try{
	...
	public int validatePrice(String fieldname, JSONObject request) throws Exception{
		try{
			return  Integer.parseInt(this.getFieldValue(fieldname, request));
		}catch (Exception e) {
			throw new Exception("The field " + fieldname + " is required");
	...
	public int validateMaxProfit(String fieldname, JSONObject request) throws Exception{
		try{
			return  Integer.parseInt(this.getFieldValue(fieldname, request));
		}catch (Exception e) {
			throw new Exception("The field " + fieldname + " is required");
	...
	public int validateMaxLoss(String fieldname, JSONObject request) throws Exception{
		try{
			return  Integer.parseInt(this.getFieldValue(fieldname, request));
		}catch (Exception e) {
			throw new Exception("The field " + fieldname + " is required");
	...
	public long validateAnalysisDataId(String fieldname, JSONObject request) throws Exception{
		try{
