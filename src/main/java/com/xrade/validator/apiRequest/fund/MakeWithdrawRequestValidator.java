...
public class MakeWithdrawRequestValidator  extends AbstractRequestValidator<MemberWithdrawRequestEntity> {
	...
	@Override
	public MemberWithdrawRequestEntity validate(JSONObject request) throws Exception {
		
		MemberWithdrawRequestEntity withdrawEntity = new MemberWithdrawRequestEntity();
	...
	@Override
	public MemberWithdrawRequestEntity validate(MemberWithdrawRequestEntity obj) {
